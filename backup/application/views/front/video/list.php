          ...
          <div class="page">
            <div id="content-posts" class="page-content pull-to-refresh-content infinite-scroll" data-distance="50">
              ...
              <!--<ul class="post-list" id="post-list" style="padding:15px;">-->
				...
				?>
				  <iframe class="full-width" style="margin:0;" src="https://player.vimeo.com/video/35330116?color=ffffff&title=0&byline=0&portrait=0" width="640" height="360" allowfullscreen></iframe>
				  <div style="margin-bottom:5px;padding:15px;margin-top:-5px;background:#f6f6f6;">
					<span style="color:#FD8E23;font-size:11px;">Video News</span>
					<h2 style="font-size:14px;">Ketum PPP Djan Faridz Kampanyekan Ahok Djarot</h2>
					<span style="font-size:11px;"><i class="icon ion-android-time"></i>Wed, 28 Mar 2017 17:26 WIB</span>
				  </div>
				  <iframe class="full-width" style="margin:0;" src="https://player.vimeo.com/video/35330116?color=ffffff&title=0&byline=0&portrait=0" width="640" height="360" allowfullscreen></iframe>
				  <div style="margin-bottom:5px;padding:15px;margin-top:-5px;background:#f6f6f6;">
					<span style="color:#FD8E23;font-size:11px;">Video News</span>
