		...
		success:function(result){
				$$.each(result, function(i, data){
					if(data.flag_id == 'FLG00001'){
						if(data.post_direct == '1'){
							...
							'<li class="promoted">'+
							  '<a onclick="location.href = '+"'"+data.post_url+"'"+';">'+
								'<div class="post-thumbnail"><img src="http://suarakaryanews.com/uploads/post/original/'+data.post_thumb+'"></div>'+
								'<div class="post-infos">'+
							...
							$$('#post-list').append(
							'<li class="promoted">'+
							  '<a onclick="location.href = '+"'http://suarakaryanews.com/index.php/berita/artikel/"+data.post_url+"'"+';">'+
								'<div class="post-thumbnail"><img src="http://suarakaryanews.com/uploads/post/original/'+data.post_thumb+'"></div>'+
								'<div class="post-infos">'+
								  '<div class="post-title"><h4>'+data.post_title+'</h4></div>'+
								  '<div class="post-category red" style="float:left">Adventorial</div>'+
						...
						"<img src='http://suarakaryanews.com/uploads/advertise/original/"+data.post_thumb+"' style='width:100%;'/>" +
						'</li>');
					}else{
						$$('#post-list').append(
							'<li>'+
				...
				var first_vii = parseInt($('#first2').val());
				var limit_vii = parseInt($('#limit2').val());
