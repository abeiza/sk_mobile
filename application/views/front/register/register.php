        ...
        <div class="pages navbar-fixed">
          <div class="page" style="overflow:auto!important">
			<div class="title-post" style="padding:15px;margin-top:45px;">
				...
				<div style="margin:10px 0px;width:100%;float:Left;margin-bottom:50px;">
					...
					<div style="width:100%;float:left;margin:5px 0;">
						...
						<input style="width:100%;float:left;font-size:12px;padding:7px 3px;border-radius:3px;border:1px solid #e1e1e1" type="password" />
					</div>
					<div style="width:100%;float:left;margin:5px 0;">
					...
					<div style="width:100%;float:left;margin:10px 0;">
						<div style="width:100%;float:left;">
							...
							<div style="width:92%;float:left;margin-top:-5px;">
								<label for='agree' style="font-size:12px;">Saya setuju dengan <a>Syarat dan Ketentuan</a> yang berlaku</label>
							</div>
						</div>
						<button style="border:1px solid #f58021;margin-top:20px;background-color:#f58021;padding:7px 0;color:#fff;font-size:12px;width:100%;border-radius:3px;">Daftar</button>
					</div>
