...
<script>
      ...
      <div id="view-main" class="view view-main tab active">
        ...
        <div class="pages navbar-fixed">
          <div class="page" style="overflow:auto!important">
			...
			<iframe width="100%" height="450" src="<?php echo $link;?>" frameborder="0" allowfullscreen></iframe>
			...
			<div class="share-section">
				...
				<div style="float:left;padding-top:0;padding-bottom:0;width:100%;">
					<div style="padding:0;" data-href="<?php echo $url_mobile.'index.php/berita/video_detail/'.$this->uri->segment(3);?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="facebook" class="fb-xfbml-parse-ignore" target="_blank" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fm.suarakaryanews.com%2Findex.php%2Fberita%2Fvideo_detail%2F<?php echo rawurlencode($this->uri->segment(3));?>&amp;src=sdkpreparse');"><i class="ion-social-facebook"></i></a></div>
					<a onclick="window.open('https://twitter.com/share');" target="_blank" class="twitter"><i class="ion-social-twitter"></i></a>
					<a href="https://plus.google.com/share?url=<?php echo rawurlencode('https://m.suarakaryanews.com/index.php/berita/video_detail/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" class="google"><i class="ion-social-googleplus"></i></a>
				...
				<div style="float:left;padding-top:0;padding-bottom:0;width:100%;">
					<a class="tag-point" onclick="location.href = '<?php echo base_url();?>index.php/berita/video_comment/<?php echo $this->uri->segment(3)?>';" style="background-color:#999;padding:5px 14px;margin:2.5px;"><i class="ion-chatbubbles"></i> Komentar</a>
				</div>
			</div>
