<!-- Swipe Pannel -->
	<div class="panel panel-right panel-reveal">
		<div style="width:84%;float:left;margin:8%;margin-bottom:-10px;">
			<div style="width:50%;float:left;"><i class='ion-ios-person' style="padding:5px 10px;border:1px solid #fff;border-radius:100%;float:left;margin-right:5px;"></i> <h6 style="font-size:12px;padding-top:5px;">Halo, Users</h6></div>
			<div style="width:50%;float:left;"><h5 style="float:right;border-left:1px dotted #fff;padding:5px;color:#fff;"><a style="color:#fff;" onclick="location.href = '<?php echo base_url();?>index.php/berita/register';">Daftar</a></h5><h5 style="float:right;padding:5px;"><a style="color:#fff;"  onclick="location.href = '<?php echo base_url();?>index.php/berita/login';">Masuk</a></h5></div>
		</div>
	<?php 
