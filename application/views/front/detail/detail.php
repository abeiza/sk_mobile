...
<script>
          ...
          <div class="page" style="overflow:auto!important;">
			...
			<div class="title-post">
				...
				<ul class="post-tags">
					...
					<li><i class="fa fa-user" style="margin-right:5px;"></i>Editor <a href="#"><?php echo $posted_main;?></a></li>
				</ul>
			</div>
			<img src="<?php echo $url_pc;?>uploads/post/original/<?php echo $pict_main;?>" style="width:100%;background-color:#fff;float:left;padding-bottom:10px;" />
			<div class="text-content" style="padding:10px;background-color:#fff;">
				<?php echo $desc_main;?>
			</div>
			<div class="tag-section" style="background-color:#fff;">
				<span>Tags : </span>
		    ...
		    <?php 
    			foreach($query_adv->result() as $pop){
    				if($pop->position_id == 'PSB00017'){
    		?>
            <div style="width:100%;float:left;background:transparent;height:200px;">
			...
			<div class="share-section">
				<div>Share</div>
				<div style="float:left;padding-top:0;padding-bottom:0;width:100%;background-color:#fff;">
					...
					<a href="https://plus.google.com/share?url=<?php echo rawurlencode('http://m.suarakaryanews.com/index.php/berita/artikel/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" class="google"><i class="ion-social-googleplus"></i></a>
				    <a onclick="window.open('whatsapp://send?text=SUARAKARYANEWS - <?php echo str_replace("'","",$title_main).' '.$shortDWName;?>');" class="whatsapp" data-action="share/whatsapp/share"><i class="ion-social-whatsapp"></i></a>
				</div>
				<div style="float:left;padding-top:0;padding-bottom:10px;width:100%;background-color:#fff;">
